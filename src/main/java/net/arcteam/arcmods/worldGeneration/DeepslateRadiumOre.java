...
public class DeepslateRadiumOre {
    ...
    public static void register() {
        ...
        new Identifier("minersworld", "deepslate_radium_ore"), ORE_CONFIGURED_FEATURE);
    	Registry.register(BuiltinRegistries.PLACED_FEATURE, new Identifier("minersworld", "deepslate_radium_ore"),
        	ORE_PLACED_FEATURE);
    	BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES,
        	RegistryKey.of(Registry.PLACED_FEATURE_KEY,
            	new Identifier("minersworld", "deepslate_radium_ore")));
    }
